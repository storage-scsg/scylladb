...
db::config::config(std::shared_ptr<db::extensions> exts)
    ...
    */
    ...
    , alternator_user_list(this, "alternator_user_list", value_status::Used, "", "User list for alternator stats")
    ...
    , repair_histroy_ttl_seconds(this, "repair_histroy_ttl_in_seconds", liveness::LiveUpdate, value_status::Used, 24*60*60, "Time for repair histroy table ttl.")
    , incremental_repair_grace_seconds(this, "incremental_repair_grace_seconds", value_status::Used, 3*60*60, "This parameter specifies the time window (in seconds) prior to the last incremental repair. Only data changes occurring within this window will be included in the current incremental repair.")
